/* =====================================================================
   BSDS ARCHIVE — SEMESTER 5 DATA (placeholder)
   =====================================================================
   Not published yet — semester5.html doesn't exist, and this
   ...
   2. Replace every "SEMESTER_DATA.sem1" below with "SEMESTER_DATA.sem5"
      and fill in this semester's real materials/syllabus/timetable/calendar.
   3. Copy semester1.html to semester5.html; update its
      <script src="js/data/sem1.js"> to sem5.js and its
      initSemesterPage('sem1') call to initSemesterPage('sem5').
   4. Create data/sem5-announcements.txt (copy data/sem1-announcements.txt
      as a starting point).
...
// SEMESTER_DATA.sem5 = { materials: {}, syllabus: [], timetable: {days:[],rows:[]}, calendar: [] };
