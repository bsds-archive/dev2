/* =====================================================================
   BSDS ARCHIVE — SEMESTER 2 DATA (placeholder)
   =====================================================================
   Not published yet — semester2.html doesn't exist, and this
   ...
   2. Replace every "SEMESTER_DATA.sem1" below with "SEMESTER_DATA.sem2"
      and fill in this semester's real materials/syllabus/timetable/calendar.
   3. Copy semester1.html to semester2.html; update its
      <script src="js/data/sem1.js"> to sem2.js and its
      initSemesterPage('sem1') call to initSemesterPage('sem2').
   4. Create data/sem2-announcements.txt (copy data/sem1-announcements.txt
      as a starting point).
...
// SEMESTER_DATA.sem2 = { materials: {}, syllabus: [], timetable: {days:[],rows:[]}, calendar: [] };
